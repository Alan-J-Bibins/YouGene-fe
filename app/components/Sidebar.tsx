...
import { Bolt, BotMessageSquare, LayoutDashboard, LucideIcon } from "lucide-react";
...
function SidebarItem({href, name, Icon, className}: {name: string, href: string, className?:string, Icon: LucideIcon}){
